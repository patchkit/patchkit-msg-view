  ...
  componentDidMount() {
    ...
    if (msg) {
      if (msg.value.content.type == 'vote') {
        ...
        ssb.get(vote.link, (err, subjectMsg) => {
          if (subjectMsg) {
            subjectMsg = { key: vote.link, value: subjectMsg }
            threadlib.decryptThread(ssb, subjectMsg, () => this.setState({ subjectMsg: subjectMsg }))
          } else
        ...
        threadlib.getPostSummary(ssb, msg.key, (err, thread) => {
          if (thread)
